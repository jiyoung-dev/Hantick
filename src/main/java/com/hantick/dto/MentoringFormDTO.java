...
public class MentoringFormDTO {
	private int mentoringform_id_seq;
	...
	public int getMentoringform_id_seq() {
		return mentoringform_id_seq;
	}

	public void setMentoringform_id_seq(int mentoringform_id_seq) {
		this.mentoringform_id_seq = mentoringform_id_seq;
	}
	...
	public String toString() {
		return "MentoringFormDTO [mentoringform_id_seq=" + mentoringform_id_seq + ", mentee_id_seq=" + mentee_id_seq
